...
Protected Class VNSPDFDocument
		...
		Sub Cell(w As Double, h As Double = 0, txt As String = "", border As Variant = 0, ln As Integer = 0, align As String = "", fill As Boolean = False, link As String = "")
		  ...
		  If txt <> "" Then
		    ...
		    If strWidth > availableWidth Then
		      ...
		      Dim textLen As Integer = txt.Length  // Desktop/Console/Web/iOS: use String.Length property
		    ...
		    If mFonts.HasKey(mCurrentFont) Then
		      ...
		      If fontInfo.HasKey("type") And fontInfo.Value("type") = "UTF8" Then
		        ...
		        If fontInfo.HasKey("usedRunes") Then
		          ...
		          Dim shapedCodePoints() As Integer = shapedText.Codepoints
	...
	#tag Method, Flags = &h0, Description = 4F7574707574732061206365C6C6C20776974682070726E74662D7374796C6520666F726D617474656420746578746
	...
	#tag Method, Flags = &h21, Description = 4372656174657320612046EFBFBD26EFBFBDEFBFBD4F626A6563742066726F6D20616E20696D706F727465642070616765
	...
	#tag Method, Flags = &h21
		Private Function EncodeTextForTrueType(txt As String, ttf As VNSPDFTrueTypeFont, Optional glyphMapping As Dictionary = Nil) As String
		  ...
		  Dim codePoints() As Integer = shapedText.Codepoints
	...
	#tag Method, Flags = &h0, Description = 43616C63756C617465732074686520776964746820EFBFBD206120737472696E6720696E207468652063757272656E7420666F6E742E
		Function GetStringWidth(s As String) As Double
		  ...
		  If fontType = "TrueType" Then
		    ...
		    Dim codePoints() As Integer = s.Codepoints
		  ...
		  Else
		    ...
		    Dim sLen As Integer = s.Length  // Desktop/Console/Web/iOS: use String.Length property
	...
	#tag Method, Flags = &h0, Description = 436865636B732069662050444620646F63756D656E7420697320696E2050444620412063F6D706C69616E6365206D6F64652E0
	...
	#tag Method, Flags = &h21, Description = 4F757470757473206F757470757420696E74656E74207374726561206F626A65637473202849434320636F6C6F72EFBFBD0726EFBFBD66EFBFBDEFBFBD32EFBFBDEFBFBD
	...
	#tag Method, Flags = &h21
		Private Function ShapeArabicText(txt As String) As String
		  ...
		  Dim codePoints() As Integer = txt.Codepoints
	...
	#tag Method, Flags = &h0, Description = 53657269616C697A657320646F63756D656E742073746174EFBFBD746F204A534F4E20737472696E672E0A
